        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-20">
            ...
            <div class="lg:col-span-1">
                ...
                <div class="flex gap-4">
                    <a href="https://github.com/abood7303" target="_blank"
                    ...
                    <a href="https://www.linkedin.com/in/abood-alkamel-39558b291?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app"
                        class="w-10 h-10 rounded-full border border-white/10 flex items-center justify-center hover:bg-accent hover:border-accent hover:text-dark-900 transition-all duration-300">
                        <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                            <path
                    ...
                    <a href="https://www.instagram.com/abdulrahmanalkamel7303?igsh=M3k3OHR2djRwa256"
                        class="w-10 h-10 rounded-full border border-white/10 flex items-center justify-center hover:bg-accent hover:border-accent hover:text-dark-900 transition-all duration-300">
                        <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                            <path
