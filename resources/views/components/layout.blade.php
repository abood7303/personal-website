...
<body class="antialiased font-sans text-text-primary selection:bg-accent selection:text-dark-900 overflow-x-hidden">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            // requestAnimationFrame(raf); // Removed redundant call
            ...
            // Card Tilt Effect
            // تأثير ميلان البطاقات مع حركة الماوس
    ...
    <a href="https://wa.me/{{ config('contact.whatsapp') }}" target="_blank" class="fixed bottom-8 right-8 z-50 group magnetic hidden md:flex">
